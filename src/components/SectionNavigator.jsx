  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        disabled={isFirst}
        className="flex items-center justify-center w-10 h-10 rounded-lg border border-gray-200 bg-white text-gray-700 hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
      ...
      {/* Progress indicator */}
      <span className="text-sm font-medium text-gray-600 tabular-nums min-w-[3rem] text-center">
        {current}/{total}
      </span>
