...
export default function Timer({ onElapsed }) {
  ...
  return (
    <div className="inline-flex items-center gap-1.5 text-sm text-gray-500 bg-white/80 rounded-full px-3 py-1 shadow-sm border border-gray-100">
      <svg
        className="w-4 h-4"
        fill="none"
        viewBox="0 0 24 24"
      ...
      <span className="font-mono tabular-nums text-gray-700">{display}</span>
    </div>
  );
}
